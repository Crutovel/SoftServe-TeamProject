...
DELETE FROM expert;
ALTER TABLE expert ALTER COLUMN id RESTART WITH 1;
DELETE FROM room;
...
ALTER TABLE english_level ALTER COLUMN id RESTART WITH 1;
DELETE FROM strategy;
ALTER TABLE strategy ALTER COLUMN id RESTART WITH 1;
DELETE FROM key_event_template;
ALTER TABLE key_event_template ALTER COLUMN id RESTART WITH 1;
DELETE FROM status_template;
ALTER TABLE status_template ALTER COLUMN id RESTART WITH 1;
DELETE FROM task_scheduler;
ALTER TABLE task_scheduler ALTER COLUMN id RESTART WITH 1;
