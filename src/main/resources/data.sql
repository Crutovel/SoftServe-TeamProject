...
insert into event_type (`name`) values ('demo');
insert into event_type (`name`) values ('lesson');
insert into room (`number`,id_location) values ('705',1);
insert into room (`number`,id_location) values ('703',1);
insert into `event` (`datetime`,duration,id_group,id_event_type,id_room) values ('2017-07-24 18:00:00',120,1,2,1);
