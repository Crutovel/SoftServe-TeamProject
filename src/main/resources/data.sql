...
insert into location (`name`,country_id) values ('Dnipro',1);
insert into location (`name`,country_id) values ('Sofia',1);
...
insert into `groups` (`name`,teacher_id,location_id,start_date,finish_date,status_id,specialization_id) values ('DP-115',1, 1,'2017-04-29','2017-08-18',4,7);
